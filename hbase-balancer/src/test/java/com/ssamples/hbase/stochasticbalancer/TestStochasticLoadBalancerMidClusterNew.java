...
public class TestStochasticLoadBalancerMidClusterNew extends BalancerTestBaseNew {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
      HBaseClassTestRule.forClass(TestStochasticLoadBalancerMidClusterNew.class);

  @Test
  public void testMidCluster0() {
    int numNodes = 5;
    int numRegions = 50;
    int numRegionsPerServer = 12; // all servers except one
    int replication = 1;
    int numTables = 5;
  ...
  public void testMidClusterTables0() {
    ...
    int replication = 1;
    int numTables = 5;
    testWithClusterTables(numNodes, numRegions, numRegionsPerServer, replication, numTables, true, true);
  }
  
  @Test
  public void testMidClusterTables() {
    int numNodes = 100;
    int numRegions = 10000;
    int numRegionsPerServer = 60; // all servers except one
    int replication = 1;
